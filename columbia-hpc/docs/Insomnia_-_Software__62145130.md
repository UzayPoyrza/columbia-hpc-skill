...
Source: https://columbiauniversity.atlassian.net/wiki/spaces/rcs/pages/62145130/Insomnia+-+Software

---

- [Table of installed Software](#Insomnia-Software-TableofinstalledSoftware)
  - [Mathematica](#Insomnia-Software-Mathematica)
  - [OpenMPI Settings](#Insomnia-Software-OpenMPISettings)
  - [RStudio in an Apptainer container](#Insomnia-Software-RStudioinanApptainercontainer)
  - [Visual Studio Code (VSCode) Server](#Insomnia-Software-VisualStudioCode(VSCode)Server)
...
| Schrodinger | 2024-1  2025-2 | module load schrodinger | A collection of software for chemical and biochemical use. It offers various tools that facilitate the investigation of the structures, reactivity and properties of chemical systems. |
...
![RStudio Option for changing directory](https://columbiauniversity.atlassian.net/wiki/download/attachments/62145130/RStudio-folder.png?api=v2)
...
If your tunnel disconnects periodically try to do the following:

In the same shell where you start the tunnel:

export XG\_RUNTIME\_DIR=/tmp/SUSER-run  
mkdir -p "$XDG\_RUNTIME\_DIR"  
chmod 700 "$XDG\_RUNTIME\_DIR"

Then restart the tunnel:

pkill -u $USER -f "code.\*tunnel" || true  
code tunnel --accept-server-license-terms --log trace
